...
<body class="home">
	...
	<form id="fstore" action="/projHY20160201/CreateGroutservlet.controller" method="post">
	<div id="storename">
...
// 			var enddate = ;
			...
			$('#save').click(function() {
				...
				var ann=$("#Tex2").val();
				arr.push({'store_name':'${newstoreno}' ,'admin_id':adminIds,'user_Ids':realUser,'groupna':groupna,'ann':ann,'enddate':enddate});
