...
public class MyGroupService {
	...
	public static void main(String[] args) {
		try {
			...
			// ------------------抓出此團購剩餘的時間------------------
//			 System.out.println(mgs.countTime(1));
			// ------------------找出此團購的商品數量------------------
...
//			System.out.println(mgs.orderDetail_ByItem(2));
			...
			// ------------------抓出"按人統計"所需資料------------------
//			System.out.println(mgs.orderDetail_ByUser(1));
			// ------------------抓出"明細列表"所需資料------------------
//			 for (String[] sb : mgs.orderDetail_detail(1)) {
...
//			};
	...
	// ------------------抓出此團購剩餘的秒數------------------
	public String getTimeSec(String times) {

		SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		String end_Date = times;

		java.util.Date d = new java.util.Date();
		String now_Date = format.format(d);

		java.util.Date d1 = null;
		java.util.Date d2 = null;

		try {
			d1 = format.parse(now_Date);
...
//    						result.get(j)[1] = String.valueOf(w+e);
    						...
    						if(sb[6].equals("y")){
    							Integer q = (Integer.parseInt(finalResult.get(j).get(3)))+1;
    							finalResult.get(j).set(3, q.toString()); 
    						}
